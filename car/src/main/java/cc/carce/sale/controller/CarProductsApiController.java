...
public class CarProductsApiController extends BaseController {
    ...
    public R<List<CarProductListDto>> getProductsList() {
        try {
            List<CarProductListDto> products = carProductsService.getPublicProducts();
     ...
     */
    @GetMapping("/category")
    public R<List<CarProductListDto>> getProductsByCategory(@RequestParam String category) {
        try {
            List<CarProductListDto> products = carProductsService.getProductsByCategory(category);
