        ...
        <div class="container">
            <div class="search-box">
                <div class="search-input-group">
                    <input type="text" class="form-control search-input" placeholder="搜尋車型、品牌或關鍵詞..." value="${searchKeyword!''}">
                ...
                <div class="filter-sidebar">
                    ...
                    <div class="filter-section">
                        ...
                        <div class="price-range">
                            <input type="number" class="form-control" placeholder="最低價格" value="${priceMin!''}">
                            <span class="price-separator">-</span>
                            <input type="number" class="form-control" placeholder="最高價格" value="${priceMax!''}">
                        </div>
                    </div>
