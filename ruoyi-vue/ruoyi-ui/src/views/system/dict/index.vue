<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="字典编號" align="center" prop="dictId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="字典名稱" prop="dictName">
          <el-input v-model="form.dictName" placeholder="请输入字典名稱" />
        </el-form-item>
        <el-form-item label="字典類型" prop="dictType">
          <el-input v-model="form.dictType" placeholder="请输入字典類型" />
        </el-form-item>
        <el-form-item label="狀態" prop="status">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        dictName: [
          { required: true, message: "字典名稱不能为空", trigger: "blur" }
        ],
        dictType: [
          { required: true, message: "字典類型不能为空", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认刪除字典编號为"' + dictIds + '"的数据项？').then(function() {
