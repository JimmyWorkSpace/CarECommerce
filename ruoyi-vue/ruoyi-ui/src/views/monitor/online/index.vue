<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="会话编號" align="center" prop="tokenId" :show-overflow-tooltip="true" />
      <el-table-column label="登入名稱" align="center" prop="userName" :show-overflow-tooltip="true" />
      <el-table-column label="部门名稱" align="center" prop="deptName" />
...
export default {
  ...
  methods: {
    ...
    handleForceLogout(row) {
      this.$modal.confirm('是否确认强退名稱为"' + row.userName + '"的用户？').then(function() {
