<template>
  <div class="app-container">
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
      ...
      <el-table-column label="访问编號" align="center" prop="infoId" />
      <el-table-column label="用户名稱" align="center" prop="userName" :show-overflow-tooltip="true" sortable="custom" :sort-orders="['descending', 'ascending']" />
      <el-table-column label="登入地址" align="center" prop="ipaddr" width="130" :show-overflow-tooltip="true" />
      <el-table-column label="登入地点" align="center" prop="loginLocation" :show-overflow-tooltip="true" />
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认刪除访问编號为"' + infoIds + '"的数据项？').then(function() {
    ...
    /** 清空按钮操作 */
    handleClean() {
      this.$modal.confirm('是否确认清空所有登入日志数据项？').then(function() {
